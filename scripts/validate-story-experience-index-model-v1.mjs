...
['krishna_stories','ramayana_journey','ganesha_stories','hanuman_stories','bedtime_stories','values_stories','festival_stories','bhagavad_gita_for_children','mahabharata_child_safe','panchatantra_hitopadesha','shloka_mantra_meanings'].forEach((c)=>types.includes(`'${c}'`)?pass(`category ${c}`):fail(`missing category ${c}`));
