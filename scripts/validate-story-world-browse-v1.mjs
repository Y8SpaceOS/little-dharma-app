...
for (let i = 66; i <= 150; i++) if (rows.find((r) => r.sprintNumber === i)?.status !== 'not_started') throw new Error(`Sprint ${i} must be not_started`);
...
for (let sprint = 66; sprint <= 150; sprint += 1) {
