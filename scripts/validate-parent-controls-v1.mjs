...
for(let n=71;n<=150;n++) if(rows.find(r=>r.n===n)?.status!=='not_started') fail(`Sprint ${n} must be not_started in CSV`);
...
if(!/### Sprint 71[\s\S]*?- \*\*Status:\*\* not started/.test(queue)) fail('Sprint 71 must be not started in MASTER_SPRINT_QUEUE');
