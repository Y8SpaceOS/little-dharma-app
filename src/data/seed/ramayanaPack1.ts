...
export const ramayanaPack1Stories: Story[] = [
  ...
  },
  {
    ...
    audioMetadata: { audioAvailable: false, voiceOptions: ['calm-narrator'], narrationScriptStatus: 'qa_ready', preferredVoiceStyle: 'gentle-storyteller', pacing: 'steady', noMicRequired: true },
    status: 'qa_ready'
  },
  {
  ...
  },
  {
    ...
    audioMetadata: { audioAvailable: false, voiceOptions: ['calm-narrator'], narrationScriptStatus: 'qa_ready', preferredVoiceStyle: 'warm-storyteller', pacing: 'steady', noMicRequired: true },
    status: 'qa_ready'
  }
];
