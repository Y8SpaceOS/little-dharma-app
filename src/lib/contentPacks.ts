...
export const seededContentPacks: ContentPack[] = [
  ...
  { id: 'ganesha-stories-pack', title: 'Ganesha Stories', childFacingTitle: 'Ganesha Stories', description: 'Gentle wisdom stories rooted in Ganesha traditions.', packType: 'story_world', sourceTradition: 'Ganesha stories', recommendedAgeBands: ['3-5', '6-8'], primaryValues: ['Patience', 'Care'], characters: ['Ganesha'], storyIds: [], journeyIds: ['ganesha-wisdom-journey'], status: 'planned', sortOrder: 2, parentTrustNote: 'Planned with calm values-first language for early childhood.', updatedAtLocal: '2026-05-18' },
