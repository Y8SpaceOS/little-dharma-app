...
const styles = StyleSheet.create({
  ...
  luvluCard: { backgroundColor: '#E8F4FF', borderRadius: 20, borderWidth: 1, borderColor: '#C8E1F8', padding: tokens.spacing.md, gap: 6 },
  luvluTitle: { fontSize: 18, fontWeight: '800', color: '#1B4E76' },
  luvluCopy: { fontSize: 15, lineHeight: 21, color: '#2D5E85' },
  sectionCard: { backgroundColor: '#FFF4DE', borderRadius: 24, borderWidth: 1, borderColor: '#F0D2A4', padding: tokens.spacing.lg, gap: 8 },
  ...
  emptyCard: { backgroundColor: '#FFF4DE', borderRadius: 24, borderWidth: 1, borderColor: '#F0D2A4', padding: tokens.spacing.lg, gap: 8 },
